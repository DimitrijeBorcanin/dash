<div>
    <x-jet-form-section submit="updateInventory">
        <x-slot name="title">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 grid grid-cols-6 gap-6">
                ...
                <!-- Top type -->
                <div class="col-span-6 lg:col-span-2">
                    @livewire('forms.select-other', ["value" => $state["top_type"], "isSelect" => $this->checkList("type", $state["top_type"]),  "list" => $lists["top_type"], "model" => "state.top_type", "title" => "Vrsta ploče", "inputId" => "top_type", "state" => "top_type"])
                ...
                <!-- Top shape -->
                <div class="col-span-6 lg:col-span-2">
                    @livewire('forms.select-other', ["value" => $state["top_shape"], "isSelect" => $this->checkList("type", $state["top_shape"]), "list" => $lists["top_shape"], "model" => "state.top_shape", "title" => "Oblik ploče", "inputId" => "top_shape", "state" => "top_shape"])
